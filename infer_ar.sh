...
bash -lc 'cd /project/peilab/srk/rss_2026_ws/diffsynth-studio &&python examples/wanvideo/model_inference/Wan2.2-TI2V-5B_challenge_rlinf_autoregressive.py --episode success__seed_000004_seg_000 --save_compare --max_sampled_frames 10000000000'